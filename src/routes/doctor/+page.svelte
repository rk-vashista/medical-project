<script>
  ...
  import { Calendar, FileText, Users, Clipboard } from 'lucide-svelte';
...
<div class="min-h-screen bg-gray-100">
      ...
      <div class="flex justify-between h-16">
        <div class="flex">
          <div class="flex-shrink-0 flex items-center">
            <img class="h-8 w-auto" src="src/lib/assets/icons/doctor.svg" alt="HealthCare Plus">
          </div>
  ...
  <header class="bg-white shadow">
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
      <h1 class="text-3xl font-bold text-gray-900">Welcome, Dr. {user?.user || 'Doctor'}</h1>
    </div>
  </header>
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      <div class="px-4 py-6 sm:px-0">
        <div class="grid md:grid-cols-2 gap-8">
              ...
              <div class="px-4 py-5 sm:p-6">
                <div class="grid grid-cols-2 gap-4">
                  <button class="bg-indigo-50 p-4 rounded-lg flex flex-col items-center justify-center transition duration-300 hover:bg-indigo-100">
                    ...
                    <span class="mt-2 text-sm font-medium text-gray-900">View Schedule</span>
                  </button>
                  <button class="bg-indigo-50 p-4 rounded-lg flex flex-col items-center justify-center transition duration-300 hover:bg-indigo-100">
                    <FileText class="h-8 w-8 text-indigo-600" />
                    <span class="mt-2 text-sm font-medium text-gray-900">Patient Records</span>
                  </button>
                  <button class="bg-indigo-50 p-4 rounded-lg flex flex-col items-center justify-center transition duration-300 hover:bg-indigo-100">
                    <Users class="h-8 w-8 text-indigo-600" />
                    <span class="mt-2 text-sm font-medium text-gray-900">Manage Patients</span>
                  </button>
                  <button class="bg-indigo-50 p-4 rounded-lg flex flex-col items-center justify-center transition duration-300 hover:bg-indigo-100">
                    <Clipboard class="h-8 w-8 text-indigo-600" />
                    <span class="mt-2 text-sm font-medium text-gray-900">Write Prescription</span>
                  </button>
                </div>
              </div>
            </div>
          ...
          <div in:fly={{ x: 50, duration: 500, delay: 300 }} out:fade>
            <div class="bg-white overflow-hidden shadow rounded-lg">
              <div class="px-4 py-5 sm:p-6">
                <h2 class="text-lg font-medium text-gray-900 mb-4">Medical Consultation Chat</h2>
        ...
        <div class="mt-8" in:fly={{ y: 50, duration: 500, delay: 600 }} out:fade>
          <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
              <h2 class="text-lg font-medium text-gray-900 mb-4">Upload Patient Records</h2>
              <FileUpload />
            </div>
          </div>
        </div>
